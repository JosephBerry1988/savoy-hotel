document.addEventListener("DOMContentLoaded", () => {
  ...
  if (typeof gsap !== "undefined" && typeof ScrollTrigger !== "undefined") {
    ...
    const progressBar = document.querySelector(".progress-bar"); // optional visual bar
    ...
    gsap.to(progressObj, {
      ...
      onUpdate: () => {
        ...
        // Optional visual bar (GPU-accelerated)
        if (progressBar) {
  ...
  parents.forEach((parent) => {
    ...
    tl.set(menu, { autoAlpha: 1 }); // fade in menu
